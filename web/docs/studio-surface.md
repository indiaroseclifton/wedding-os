# Vowfolk Studio visual direction

Preserve the post-audit wedding planner and existing Vowfolk brand. Studio should feel like a compact editorial workshop for people making their wedding: photographs on discovery surfaces, practical material controls and a large visual canvas inside a project, quiet instructions in the helper guide.
...
Visual honesty: distinguish reference photography, measured procedural previews and AI concepts. Never call a model an exact photograph of the finished wedding. Uploaded artwork is preferred over generated placeholder stationery. Dimension and source assumptions remain editable; each changed visual should update production requirements.
